====================================================
Compute API v2 StarlingX extensions
====================================================

StarlingX extensions to the OpenStack Compute API include:
...
-  Support for various new Flavor Extra Specs to enable
   StarlingX-specific optimizations and capabilities for compute servers.
...
The StarlingX extensions to the server entity are:
