...
These are the draft Release Notes for the first StarlingX release
stx.2018.10. StarlingX uses "year.month" for release version numbers.
The StarlingX stx.2018.10 release will be available in October 2018.
...
Please take a look
`here <https://wiki.openstack.org/wiki/StarlingX/stx.2018.10_Testplan>`__
for the list of tests to be executed on this release.

Testing progress can be checked
`in this page <https://wiki.openstack.org/wiki/StarlingX/stx.2018.10_TestingSummary>`__
