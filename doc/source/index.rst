...
----------------------------------
Welcome to StarlingX Documentation
----------------------------------

This is the documentation for StarlingX release stx.2018.10.
...
StarlingX utilized tooling and CI/CD environments from the OpenStack
Foundation. The source is hosted on `OpenStack's Gerrit server`_.

.. _`OpenStack's Gerrit server`: https://git.starlingx.io

Additional information regarding contributing can be found in the
:ref:`StarlingX contributor guides <contribute>`.
