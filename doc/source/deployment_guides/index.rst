...
Deployment steps for StarlingX are release-specific.
...
- The "current" release is the most recent offically released version of StarlingX.
  ...
  .. toctree::
     ...
     ../installation_guide/current/simplex
     ../installation_guide/current/duplex
     ../installation_guide/current/controller_storage
     ../installation_guide/current/dedicated_storage
