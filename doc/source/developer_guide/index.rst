...
creation. This section describes ow to cusomize the base Docker image
building process.
...
Create your ``localrc`` configuration file, this is a sample:
...
The creation of the StarlingX ISO relies in a repository of RPM Binaries,
